...
struct Driver::Ccm
{
	/* Function Register Fractional Phase-Locked Loop (PLL) clocks */
	...
	/* Function Register System Phase-Locked Loop (PLL) clocks */
	...
	addr_t pll_base(unsigned pll)
	{
		return (addr_t)ccm_analog_regs.local_addr<const void>() + pll;
	}

	addr_t sccg_pll_base(unsigned pll) {
		return (addr_t)ccm_analog_regs.local_addr<const void>() + 0x94 + pll * 0x10;
	}
	...
	Frac_pll audio_pll1_clk { clocks, "audio_pll1_clk", pll_base(0x0) };
	Frac_pll audio_pll2_clk { clocks, "audio_pll2_clk", pll_base(0x14) };
	Frac_pll video_pll1_clk { clocks, "video_pll1_clk", pll_base(0x28) };
	Frac_pll dram_pll_clk   { clocks, "dram_pll_clk",   pll_base(0x50) };
	Frac_pll gpu_pll_clk    { clocks, "gpu_pll_clk",    pll_base(0x64) };
	...
	Root_clock lcdif_pixel_clk_root          { clocks, "lcdif_pixel_clk_root",
	                                           root_base(74), m24_ref_clk,
	                                           video_pll1_clk, audio_pll2_clk,
	                                           audio_pll1_clk, system_pll1_clk,
	                                           system_pll2_clk, system_pll3_clk, ext_clk_4 };
	Root_clock sai1_clk_root                 { clocks, "sai1_clk_root",
	                                           root_base(75), m24_ref_clk,
	...
	Root_clock usdhc2_clk_root               { clocks, "usdhc2_clk_root",
	                                           root_base(89), m24_ref_clk,
	                                           system_pll1_div2, system_pll1_clk,
	                                           system_pll2_div2, system_pll3_clk,
	                                           system_pll1_div3, audio_pll2_clk, system_pll1_div8 };
	Root_clock i2c1_clk_root                 { clocks, "i2c1_clk_root",
	                                           root_base(90), m24_ref_clk,
	...
	Gate usdhc3_gate     { clocks, "usdhc3_gate",     gate_base(94),  usdhc3_clk_root         };
